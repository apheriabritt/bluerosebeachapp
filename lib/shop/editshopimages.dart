...
class EditImages extends StatefulWidget {
  EditImages(this.shopimagesdata);

  getShopImagesData shopimagesdata;
  @override
  _EditImagesState createState() => _EditImagesState(this.shopimagesdata);
}

class _EditImagesState extends State<EditImages> {
  _EditImagesState(this.shopimagesdata);
  getShopImagesData shopimagesdata;
  ...
  void initState() {
    super.initState();
    print(description);
    print("old image 1: ${shopimagesdata.oldimage1.toString()}");
    print("old image 2: ${shopimagesdata.oldimage2.toString()}");
    print("old image 3: ${shopimagesdata.oldimage3.toString()}");
    print("old image 4: ${shopimagesdata.oldimage4.toString()}");
    print("old image 5: ${shopimagesdata.oldimage5.toString()}");





    if(shopimagesdata.oldimage1!=null)
    {oldimage1= shopimagesdata.oldimage1;}
    else{
      oldimage1=null;}

    if(shopimagesdata.oldimage2!='')
    {oldimage2= shopimagesdata.oldimage2;}
    else{
      oldimage2=null;}

    if(shopimagesdata.oldimage3!='')
    {oldimage3= shopimagesdata.oldimage3;}
    else{
      oldimage3=null;}

    if(shopimagesdata.oldimage4!='')
    {oldimage4= shopimagesdata.oldimage4;}
    else{
      oldimage4=null;}

    if(shopimagesdata.oldimage5!='')
    {oldimage5= shopimagesdata.oldimage5;}
    else{
      oldimage5=null;}
  ...
  void postimages () async {
    ...
    if (finalimage1==null){finalimage1=shopimagesdata.oldimage1.toString();}
    if (finalimage2==null){finalimage2=shopimagesdata.oldimage2.toString();}
    if (finalimage3==null){finalimage3=shopimagesdata.oldimage3.toString();}
    if (finalimage4==null){finalimage4=shopimagesdata.oldimage4.toString();}
    if (finalimage5==null){finalimage5=shopimagesdata.oldimage5.toString();}
    ...
    print(shopid);
    ref.child("shops")
        .child(shopimagesdata.shopid.toString())
        .update(data);
    Navigator.push(
      context,
                          ...
                          child: Form(
                            ...
                            child: ListView(
                              children: <Widget>[
                                ...
                                TextFormField(
                                  maxLines: 5,
                                  initialValue: shopimagesdata.description,
                                  style: TextStyle(
                                      fontFamily: 'apheriafont',
                                      fontSize: 25.0,
                                      color: Color(0xff98C7E3)),
