...
class UploadShop extends StatefulWidget {
  UploadShop({Key key}) : super(key: key);
  @override
  _UploadShopState createState() => new _UploadShopState();
}
...
class _UploadShopState extends State<UploadShop> {
  ...
  void post () async {
    ...
    int shopid=DateTime.now().millisecondsSinceEpoch;
    ...
    print(shopid);
    ref.child("shops").child(shopid.toString()).set(data);
    Navigator.push(
      context,
